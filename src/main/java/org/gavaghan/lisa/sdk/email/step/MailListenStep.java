...
public abstract class MailListenStep extends BaseListenStep
{
	...
	static final String STATE_KEY = MailListenStep.class.getName() + ".STATE";

	/** Key to our QUIT flag in TestExec. */
	static final String QUIT_KEY = MailListenStep.class.getName() + ".QUIT";
	...
	static final String SESSION_KEY = MailListenStep.class.getName() + ".SESSION";
